...
--
-- Host: localhost    Database: llr_db
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`delivery_status_id`) REFERENCES `delivery_status` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-06-07 14:54:48
